...
const RoomTypeCard = ({ room }) => {
    const handleWhatsAppBooking = () => {
        ...
        const message = `Halo Admin Debu Kost,
            ...
            <div className="flex flex-col md:flex-row gap-6">
                <div className="md:w-1/3">
                    <div className="relative overflow-hidden rounded-lg">
                        ...
                        />
                        {room.isAvailable ? (
                            <Badge className="absolute top-2 right-2 bg-green-500 text-white">Tersedia</Badge>
                        ) : (
                            <Badge className="absolute top-2 right-2 bg-red-500 text-white">Terisi</Badge>
                        )}
                    </div>
                </div>
                ...
                <div className="md:w-2/3">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="text-right">
                            <p className="text-2xl font-bold text-blue-600">Rp {room.price.toLocaleString()}</p>
